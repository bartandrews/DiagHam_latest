...
//
ParticleOnTorusCoulombHamiltonian::ParticleOnTorusCoulombHamiltonian(ParticleOnTorus* particles, int nbrParticles, int maxMomentum, double ratio, int landauLevel, AbstractArchitecture* architecture, long memory, char* precalculationFileName)
{
