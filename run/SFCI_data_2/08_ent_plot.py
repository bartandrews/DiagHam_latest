...
if __name__ == "__main__":
    ...
    file_name = f"{stats}_alpha_{alpha}_q_{q}_ent{numb_tag}_3"

    mb_data = f"/home/bart/DiagHam_latest/run/SFCI_data_2/{stats}_alpha_{alpha:g}{numb_tag}/q_{q:g}/ent/mb_ent_q_{q:g}.txt"
