...
if __name__ == "__main__":
    ...
    mb_file = "bosons_hofstadter_X_15_Y_8_q_1_n_9_x_3_y_6_t3_1.31_t6_-0.25_t9_-0.25_u_1_gx_0_gy_0_ext.dat"
    lin_K = []
    mb_E = []
    with open(os.path.join("q120/n9", mb_file), 'r') as csvfile:
    ...
    mb_file2 = "bosons_hofstadter_X_15_Y_8_q_1_n_9_x_3_y_6_t3_-1.81_t6_0.25_t9_0.25_u_1_gx_0_gy_0_ext.dat"
    lin_K2 = []
    mb_E2 = []
    with open(os.path.join("q120/n9", mb_file2), 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=' ')
        for i, row in enumerate(plots):
            if can_convert_to_float(row[0]):
    ...
    ent_file = "bosons_hofstadter_X_15_Y_8_q_1_n_9_x_3_y_6_t3_1.31_t6_-0.25_t9_-0.25_u_1_gx_0_gy_0.na_4.parentspec"
    lin_K_ent = []
    ent = []
    with open(os.path.join("q120/n9/ent", ent_file), 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=' ')
        for i, row in enumerate(plots):
            if can_convert_to_float(row[0]):
    ...
    ent_file2 = "bosons_hofstadter_X_15_Y_8_q_1_n_9_x_3_y_6_t3_-1.81_t6_0.25_t9_0.25_u_1_gx_0_gy_0.na_4.parentspec"
    lin_K_ent2 = []
    ent2 = []
    with open(os.path.join(f"q120/n9/ent", ent_file2), 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=' ')
        for i, row in enumerate(plots):
            if can_convert_to_float(row[0]):
    ...
    # extract data
    fs_file = f"data_bosons_q120.txt"
    invertN = []
    ...
    plt.savefig(f"/home/bart/DiagHam_latest/run/SFCI_data_2/plots/case_study_bosons/bosons_q120.png",
