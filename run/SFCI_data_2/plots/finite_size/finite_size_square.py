...
if __name__ == "__main__":
    ...
    mb_file = f"script_output/q128/n6/fermions_hofstadter_X_16_Y_8_q_1_n_6_x_3_y_6_t3_1.31_t6_-0.25_t9_-0.25_u_1_gx_0_gy_0_ext.dat"
    mb_E = []
    ...
    mb_E = sorted(mb_E)
    gaps_left.append(128**2 *(mb_E[3]-mb_E[2]))
    ...
    # extract many-body gap
    mb_file = f"script_output/q189/n7/fermions_hofstadter_X_21_Y_9_q_1_n_7_x_3_y_7_t3_1.31_t6_-0.25_t9_-0.25_u_1_gx_0_gy_0_ext.dat"
    mb_E = []
    with open(mb_file, 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=' ')
        for i, row in enumerate(plots):
            if can_convert_to_float(row[0]):
                mb_E.append(float(row[2]) / 2)
    mb_E = sorted(mb_E)
    gaps_left.append(189**2 *(mb_E[3] - mb_E[2]))
    ...
    # extract many-body gap
    mb_file = f"script_output/q150/n8/fermions_hofstadter_X_15_Y_10_q_1_n_8_x_4_y_6_t3_1.31_t6_-0.25_t9_-0.25_u_1_gx_0_gy_0_ext.dat"
    mb_E = []
    with open(mb_file, 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=' ')
        for i, row in enumerate(plots):
            if can_convert_to_float(row[0]):
                mb_E.append(float(row[2]) / 2)
    mb_E = sorted(mb_E)
    gaps_left.append(150**2 *(mb_E[3] - mb_E[2]))
    ...
    # extract many-body gap
    mb_file = f"script_output/q147/n9/fermions_hofstadter_X_21_Y_7_q_1_n_9_x_3_y_9_t3_1.31_t6_-0.25_t9_-0.25_u_1_gx_0_gy_0_ext.dat"
    mb_E = []
    with open(mb_file, 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=' ')
        for i, row in enumerate(plots):
            if can_convert_to_float(row[0]):
                mb_E.append(float(row[2]) / 2)
    mb_E = sorted(mb_E)
    gaps_left.append(147**2 * (mb_E[3] - mb_E[2]))
    ...
    # extract many-body gap
    mb_file = f"script_output/q120/n10/fermions_hofstadter_X_12_Y_10_q_1_n_10_x_5_y_6_t3_1.31_t6_-0.25_t9_-0.25_u_1_gx_0_gy_0_ext.dat"
    mb_E = []
    with open(mb_file, 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=' ')
        for i, row in enumerate(plots):
            if can_convert_to_float(row[0]):
                mb_E.append(float(row[2]) / 2)
    mb_E = sorted(mb_E)
    gaps_left.append(120**2 * (mb_E[3] - mb_E[2]))
    ...
    # extract many-body gap
    mb_file = f"script_output/q128/n6/fermions_hofstadter_X_16_Y_8_q_1_n_6_x_3_y_6_t3_-1.81_t6_0.25_t9_0.25_u_1_gx_0_gy_0_ext.dat"
    mb_E = []
    with open(mb_file, 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=' ')
        for i, row in enumerate(plots):
            if can_convert_to_float(row[0]):
                mb_E.append(float(row[2]) / 2)
    mb_E = sorted(mb_E)
    gaps_right.append(128**2 *(mb_E[3] - mb_E[2]))
    ...
    # extract many-body gap
    mb_file = f"script_output/q189/n7/fermions_hofstadter_X_21_Y_9_q_1_n_7_x_3_y_7_t3_-1.81_t6_0.25_t9_0.25_u_1_gx_0_gy_0_ext.dat"
    mb_E = []
    with open(mb_file, 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=' ')
        for i, row in enumerate(plots):
            if can_convert_to_float(row[0]):
                mb_E.append(float(row[2]) / 2)
    mb_E = sorted(mb_E)
    gaps_right.append(189**2 * (mb_E[3] - mb_E[2]))
    ...
    # extract many-body gap
    mb_file = f"script_output/q150/n8/fermions_hofstadter_X_15_Y_10_q_1_n_8_x_4_y_6_t3_-1.81_t6_0.25_t9_0.25_u_1_gx_0_gy_0_ext.dat"
    mb_E = []
    with open(mb_file, 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=' ')
        for i, row in enumerate(plots):
            if can_convert_to_float(row[0]):
                mb_E.append(float(row[2]) / 2)
    mb_E = sorted(mb_E)
    gaps_right.append(150**2 *(mb_E[3] - mb_E[2]))
    ...
    # extract many-body gap
    mb_file = f"script_output/q147/n9/fermions_hofstadter_X_21_Y_7_q_1_n_9_x_3_y_9_t3_-1.81_t6_0.25_t9_0.25_u_1_gx_0_gy_0_ext.dat"
    mb_E = []
    with open(mb_file, 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=' ')
        for i, row in enumerate(plots):
            if can_convert_to_float(row[0]):
                mb_E.append(float(row[2]) / 2)
    mb_E = sorted(mb_E)
    gaps_right.append(147**2 * (mb_E[3] - mb_E[2]))
    ...
    # extract many-body gap
    mb_file = f"script_output/q120/n10/fermions_hofstadter_X_12_Y_10_q_1_n_10_x_5_y_6_t3_-1.81_t6_0.25_t9_0.25_u_1_gx_0_gy_0_ext.dat"
    mb_E = []
    with open(mb_file, 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=' ')
        for i, row in enumerate(plots):
            if can_convert_to_float(row[0]):
                mb_E.append(float(row[2]) / 2)
    mb_E = sorted(mb_E)
    gaps_right.append(120**2 * (mb_E[3] - mb_E[2]))
    ...
    ax0.plot([1/i for i in numbs], gaps_left, '.-')
    ...
    ax1.plot([1 / i for i in numbs], gaps_right, '.-')
    ...
    plt.savefig(f"/home/bart/DiagHam_latest/run/SFCI_data_2/plots/finite_size/finite_size_square.png",
