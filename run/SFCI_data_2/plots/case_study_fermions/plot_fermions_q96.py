...
if __name__ == "__main__":
    ...
    ent_file2 = "ent/fermions_hofstadter_X_16_Y_6_q_1_n_11_x_3_y_11_t3_-1.81_t6_0.25_t9_0.25_u_1_gx_0_gy_0.na_5.parentspec"
    lin_K_ent2 = []
    ent2 = []
    with open(os.path.join(f"q{q}/n11", ent_file2), 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=' ')
        for i, row in enumerate(plots):
            if can_convert_to_float(row[0]):
